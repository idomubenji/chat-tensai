process.env.NEXT_PUBLIC_SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://wzronhnlmkqvgdydzyih.supabase.co';
...
process.env.NEXT_PUBLIC_TENSAI_KEY = 'test_tensai_key';
